export const SYSTEM_PROMPT =
  ...
  '4. The current page URL is provided in the injected context. Always resolve relative URLs (e.g. /path, ../page, ?query) against this base URL before using them. Never pass relative URLs to any tool or show them to the user without resolving them first.\n' +
